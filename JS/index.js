...
window.onload = () => {
 ...
 /////////////////////////////////////////////////////////
    ...
    let time = parseInt(document.getElementById("time-counter").textContent);
    
    let timeRemaining = 120
    setInterval(() => {
        timeRemaining--;
        time.innerHTML = String(timeRemaining);
...
////////////////////////////////////////////////////////////
  ...
  function startGame() {
    if (!gameOver) {gameInterval = requestAnimationFrame(startGame);
